...
define([
  ...
  function(ConfigManager, LayoutManager, DataManager, WidgetManager, FeatureActionManager, SelectionManager,
    ...
    portalUrlUtils, jimuUtils, require, i18n, mainBundle, esriMain, dojoReady, esriBundle) {
    ...
    window.wabVersion = '2.12';
    // window.productVersion = 'Online 7.1';
    window.productVersion = 'Web AppBuilder for ArcGIS (Developer Edition) 2.12';
    // window.productVersion = 'Portal for ArcGIS 10.7';

    function initApp() {
      var urlParams, configManager, layoutManager;
      console.log('jimu.js init...');
      esriBundle.widgets.popup.NLS_noInfo = "Click on a point or polygon feature";
